...
{
    if ((control_mode == AUTO || (control_mode==RTL && auto_state.checked_for_autoland)) && flight_stage == AP_SpdHgtControl::FLIGHT_LAND_FINAL) {
        ...
        if ((control_mode == AUTO || (control_mode==RTL && auto_state.checked_for_autoland)) &&
